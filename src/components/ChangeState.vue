<template>
  ...
  <div id="wrapper">
    <div id="details">
      ...
      <div id="selectAll" v-on:click="selectAll">전체선택</div>
      <div id="clearAll" v-on:click="clearAll">선택취소</div>
    </div>
    <div id="btn-wrapper">
      ...
      <div class="btn" v-on:click="actionBtn('훈련')" style="grid-column:2/3; grid-row:3/4; background: #FF8F00">훈련</div>
      
      <div class="btn" v-on:click="actionBtn('휴가')" style="grid-column:4/5; grid-row:1/2; background: #424242">휴가</div>
      <div class="btn" v-on:click="actionBtn('정비')" style="grid-column:4/5; grid-row:2/3; background: #616161">정비</div>
      <div class="btn" v-on:click="actionBtn('외진')" style="grid-column:4/5; grid-row:3/4; background: #757575">외진</div>
      
      <div class="btn" v-on:click="actionBtn('동문')" style="grid-column:3/4; grid-row:1/2; background: #263238">동문</div>
      <div class="btn" v-on:click="actionBtn('식기')" style="grid-column:3/4; grid-row:2/3; background: #37474F">식기</div>
      <div class="btn" v-on:click="actionBtn('배식')" style="grid-column:3/4; grid-row:3/4; background: #455A64">배식</div>
    </div>
  </div>
</template>
